...
#include "gcopter/MathUtils.hpp"
#include <cmath>
#include <cassert>
#include <iostream>
#include <algorithm>
#include <limits>
#include "gcopter/Structs/Mesh.hpp"
...
namespace quickhull {
	...
	// template ConvexHull<double> QuickHull<double>::getConvexHull(const double*, size_t, bool, bool, double);
	// template ConvexHull<float> QuickHull<float>::getConvexHull(const float*, size_t, bool, bool, float);
